...
class TestTemperatureServiceSerialization(unittest.TestCase):
    ...
    def test_serialize_temperature_response(self):
        response = TemperatureResponse(average_temperature=22.5, status="Good", data_age_seconds=None)
    ...
    def test_deserialize_temperature_response(self):
        payload = {"average_temperature": "20.0", "status": "Good", "data_age_seconds": None}
